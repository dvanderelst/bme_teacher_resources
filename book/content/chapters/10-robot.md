...
![Cable for connecting sensors to the robot's ports.](images/introduction-to-the-robot-676c1e4d.png)
...
The on/off switch appears in the image below. The robot also has a USB port. As described later, you can also program via USB. However, the recommended method is wireless connection (see [Getting started with the robot](#getting-started-with-the-robot)).
