...
> **Note**
>
> Please run through the sections explaining how to install the software and how to connect to the robot before trying to run the current example program.
...
![](images/running-your-first-program-752f3ce5.png)
