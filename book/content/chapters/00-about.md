...
broad Next Generation Science Standards (NGSS Lead States, 2013) and International Society for
Technology in Education standards (ISTE, 2022); the alignment for each lesson is listed in the
*Educational standards* chapter.

Supported by the National Science Foundation under ITEST grants **DRL 1759150** and **DRL 2342578**.
Any opinions, findings, and conclusions expressed here are those of the authors and do not
...
You are free to share and adapt these materials for **non-commercial** purposes, provided you give
credit, link to the licence, and indicate if you made changes. Please do adapt them — cut lessons
down, reorder activities, translate them, rewrite the worksheets for your students.

When you do, please credit us as:

> Biology Meets Engineering teacher materials, University of Cincinnati.
> Supported by NSF ITEST DRL 1759150 and DRL 2342578. Used under CC BY-NC 4.0.

That attribution is how the project demonstrates its reach to the funder, so it genuinely helps us
if you include it.

If you are unsure whether your use counts as non-commercial — a paid teacher-training workshop, a
fee-charging summer programme, a private school — please just ask. The intent is to keep these
materials free for teachers, not to obstruct anyone teaching with them.
