...
**External websites:**
- [github.com/dvanderelst/bme_teacher_resources](https://github.com/dvanderelst/bme_teacher_resources) (Source files for these materials.)

### Chapter 1: Introduction to the robot

**External websites:**
- [Makeblock](https://www.makeblock.com) (Manufacturer of the mBot robot and mBlock software.)
- [Assemble mBot](https://support.makeblock.com/hc/en-us/articles/12822859943959-A-Beginner-s-Guide-to-mBot#Assemble%20mBot) (Official assembly instructions for the mBot robot.)

### Chapter 2: Installing mBlock

**External websites:**
- [mblock.cc/pages/downloads](https://mblock.cc/pages/downloads) (Official download page for mBlock software and mLink helper program.)
- [ide.mblock.cc](https://ide.mblock.cc) (Block-based online editor used throughout the lesson plans.)
- [python.mblock.cc](https://python.mblock.cc) (Python-based editor not used in these materials.)

### Chapter 5: Introduction to Programming

**External websites:**
- [consult this manual](https://sandstechnology.com/manuals/manual17.htm) (Programming manual for ST Robotics robot arms.)
...
- [How color vision happens in the eye (Medium)](https://medium.com/age-of-awareness/red-light-green-light-yellow-light-heres-how-it-happens-in-the-eye-and-how-to-teach-it-4e0c4bb96b8) (Medium article explaining the biology of color vision.)
- [colorvisionapp.up.railway.app](https://colorvisionapp.up.railway.app/) (Web application for color vision activities; no installation required.)
...
- [Wikimedia Commons: the pipistrelle recording](https://commons.wikimedia.org/wiki/File:Chirps190918-22s.mp3) (The original of the slowed-down bat recording below, with its full description and license.)
...
- [CC BY-SA 4.0](https://creativecommons.org/licenses/by-sa/4.0/) (License of the sensory homunculus photograph.)

---

## Email addresses

- [dejarnam@ucmail.uc.edu](mailto:dejarnam@ucmail.uc.edu)
- [laynejr@ucmail.uc.edu](mailto:laynejr@ucmail.uc.edu)
- [rollmasm@ucmail.uc.edu](mailto:rollmasm@ucmail.uc.edu)
